    ...
    function apply(ctx) {
      ...
      function BalanceDisplay() {
        ...
        if (error) {
          ...
          return react.createElement('div', { id: READOUT_ID, title: error, style: Object.assign({}, baseStyle, { color: 'var(--dsw-alias-state-error-primary, #e53e3e)', opacity: 0.8 }) }, '\u26A0\uFE0F ' + errMsg);
        }
