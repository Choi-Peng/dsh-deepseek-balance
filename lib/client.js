    ...
    function apply(ctx) {
      ...
      function BalanceDisplay() {
          ...
          async function doFetch() {
            try {
              ...
              if (result && result.error) {
                ...
                setBalances([]);
              } else if (result && Array.isArray(result.balances)) {
        ...
        var segments = balances.map(function (item, i) {
          ...
          return react.createElement('span', { key: i, style: { color: 'var(--dsw-alias-label-secondary, #888)', fontWeight: 500 } }, num.toFixed(2) + ' ' + cur);
        });
